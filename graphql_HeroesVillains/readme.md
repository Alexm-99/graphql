...
En este README te explicaré sobre un programa en Python que utiliza una API en GraphQL para obtener información sobre héroes y villanos. Para poder ejecutar este programa, necesitarás tener las siguientes dependencias instaladas:
...
El programa se conectará a la API en GraphQL y levantará un servidor para realizar una serie de consultas para obtener información sobre héroes y villanos.
